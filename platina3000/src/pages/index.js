...
const IndexPage = () => {
  const [mostEpul, setMostEpul] = useState({});
  useEffect(() => {
    fetch("https://api-eu-central-1.graphcms.com/v2/ckwq5z05y2e8n01xmgomm92ka/master?query=%23%20Welcome%20to%20GraphiQL%0A%23%0A%23%20GraphiQL%20is%20an%20in-browser%20tool%20for%20writing%2C%20validating%2C%20and%0A%23%20testing%20GraphQL%20queries.%0A%23%0A%23%20Type%20queries%20into%20this%20side%20of%20the%20screen%2C%20and%20you%20will%20see%20intelligent%0A%23%20typeaheads%20aware%20of%20the%20current%20GraphQL%20type%20schema%20and%20live%20syntax%20and%0A%23%20validation%20errors%20highlighted%20within%20the%20text.%0A%23%0A%23%20GraphQL%20queries%20typically%20start%20with%20a%20%22%7B%22%20character.%20Lines%20that%20starts%0A%23%20with%20a%20%23%20are%20ignored.%0A%23%0A%23%20An%20example%20GraphQL%20query%20might%20look%20like%3A%0A%23%0A%23%20%20%20%20%20%7B%0A%23%20%20%20%20%20%20%20field(arg%3A%20%22value%22)%20%7B%0A%23%20%20%20%20%20%20%20%20%20subField%0A%23%20%20%20%20%20%20%20%7D%0A%23%20%20%20%20%20%7D%0A%23%0A%23%20Keyboard%20shortcuts%3A%0A%23%0A%23%20%20Prettify%20Query%3A%20%20Shift-Ctrl-P%20(or%20press%20the%20prettify%20button%20above)%0A%23%0A%23%20%20%20%20%20Merge%20Query%3A%20%20Shift-Ctrl-M%20(or%20press%20the%20merge%20button%20above)%0A%23%0A%23%20%20%20%20%20%20%20Run%20Query%3A%20%20Ctrl-Enter%20(or%20press%20the%20play%20button%20above)%0A%23%0A%23%20%20%20Auto%20Complete%3A%20%20Ctrl-Space%20(or%20just%20start%20typing)%0A%23%0A%0A%7B%0A%20%20mostEpuls%20%7B%0A%20%20%20%20id%0A%20%20%20%20title%0A%20%20%20%20picture%20%7B%0A%20%20%20%20%20%20id%0A%20%20%20%20%20%20fileName%0A%20%20%20%20%7D%0A%20%20%20%20%0A%20%20%7D%0A%7D%0A%0A")
      .then(res => res.json())
      .then(json => setMostEpul(json));
  }, [])
  
  console.log(mostEpul)
  return (
    <html lang="en">
        <head>
            <meta charset="UTF-8"/>
        ...
        <body>
            <header class="flex">
                ...
                <div class="pages mr-2">
                    <a href="#" id="current-page">Főoldal</a>
                    <a href="#work">Kivitelezés</a>
                    <a href="#prices">Árak</a>
                    <a href="#planning">Tervezés</a>
                    <a href="most_epul.html">Most épül</a>
                    <a href="referenciak.html">Referenciák</a>
                    <a href="elado.html">Eladó</a>
            ...
            <main>
                <section id="house" class="grid pb-4 pl-3">
                        <div class="text ml-4 mt-4">
                            <h4 class="mb-05"><strong class="slash">\</strong> Garantáltan stressz mentesen</h4>
                            <h2 class="mb-2">Családi ház építés</h2>
                            ...
                            <div class="contact mt-4">
                                <a href="#contact" class="btn"><div class="btn-text">Beszéljünk <img class="ml-05" src="./assets/img/headset.png" alt=""/></div></a>
                            </div>
                        </div>
                        <div class="image"></div>
                </section>
                <section id="work" class="grid pt-4 px-3">
                    <div class="image ml-4"></div>
                    <div class="text mx-4">
                        <h4 class="mb-05"><strong class="slash">\</strong> Magas elvárás a dolgozók felé</h4>
                        <h2 class="mb-2">Munkavégzés magas<br/> színvonalon</h2>
                ...
                <section id="key-ready" class="grid pt-6 px-3">
                    <div class="text mx-4">
                        <h4 class="mb-05"><strong class="slash">\</strong> Hatékony kivitelező csapat</h4>
                        <h2 class="mb-2">Gyors kulcsrakész családi ház</h2>
                    ...
                    <div class="image mr-4"></div>
                </section>
                <section id="general" class="grid mt-6 mb-6">
                    <div class="image ml-4"></div>
                    <div class="text mx-4">
                        <h4 class="mb-05"><strong class="slash">\</strong> Minden munkakör egy kézben</h4>
                        <h2 class="mb-2">Generálkivitelezés</h2>
                ...
                <section id="slider">
                    <div class="swiper mySwiper py-4">
                        <div class="swiper-wrapper">
                          <div class="swiper-slide"><div class="pic-1"></div></div>
                          <div class="swiper-slide"><div class="pic-2"></div></div>
                          <div class="swiper-slide"><div class="pic-3"></div></div>
                          <div class="swiper-slide"><div class="pic-4"></div></div>
                          <div class="swiper-slide"><div class="pic-5"></div></div>
                          <div class="swiper-slide"><div class="pic-6"></div></div>
                          <div class="swiper-slide"><div class="pic-7"></div></div>
                          <div class="swiper-slide"><div class="pic-8"></div></div>
                          <div class="swiper-slide"><div class="pic-9"></div></div>
                        </div>
                ...
                <section id="prices" class="my-6">
                    <div class="text mx-4">
                        <h4 class="mb-05"><strong class="slash">\</strong> Áraink</h4>
                        <h2 class="mb-2">Mennyibe kerül egy négyzetméter?</h2>
                ...
                <section id="planning-2" class="py-4">
                    <div class="container accordions-wrapper">
                        ...
                        <div class="border">
                            <div class="accordion-wrapper">
                                <div class="accordion">Árajánlat</div>
                                <div class="panel">
                        ...
                        <div class="border">
                            <div class="accordion-wrapper">
                                <div class="accordion">Tervezési szerződés</div>
                                <div class="panel">
                        ...
                        <div class="border">
                            <div class="accordion-wrapper">
                                <div class="accordion">Vázlatterv (M=1:100)</div>
                                <div class="panel">
                        ...
                        <div class="border">
                            <div class="accordion-wrapper">
                                <div class="accordion">Hivatalos dokumentumok kiváltása</div>
                                <div class="panel">
                        ...
                        <div class="border">
                            <div class="accordion-wrapper">
                                <div class="accordion">Dokumentum beadása</div>
                                <div class="panel">
                ...
                <section id="about-us" class="my-4">
                    <div class="text mx-4">
                        <h4 class="mb-05"><strong class="slash">\</strong> Rólunk</h4>
                        <h2 class="mb-1">Cégismertető</h2>
                        <p class="w-70 mx-1 mb-4">Cégünk 2000 óta tartó minőségpolitikájának és hosszú távú céljainak fő záloga a szakemberek kiválasztása, folyamatos képzése anyagi és erkölcsi megbecsülése. </p>
                    </div>
                    <div class="grid props mb-4">
                        <div class="prop">
                            <img src="./assets/img/quality.png" alt="quality"/>
                            <p class="w-100">Magas színvonalú minőség</p>
                        </div>
                        <div class="prop">
                            <img src="./assets/img/fast-delivery.png" alt="quality"/>
                            <p class="w-100">Határidők betartása</p>
                        </div>
                        <div class="prop">
                            <img src="./assets/img/best-choice.png" alt="quality"/>
                            <p class="w-100">Ügyfeleink bizalma</p>
                        </div>
                    </div>
                    <p class="mx-6 text-left">A kezdeti lakásfelújításokat napjainkra széles körű szolgáltatásokkal kiegészült építőipari tevékenység váltotta fel. Saját telephellyel, munkagépekkel, tervezőirodával és megbízható szakembergárdával állunk ügyfeleink rendelkezésére. 
                    ...
                    <div class="grid props my-8">
                        <div><a href="wienerberger.hu"><img src="./assets/img/phoroterm.png" alt=""/></a></div>
                        <div><a href="https://www.ytong.hu/"><img src="./assets/img/prokoncept.png" alt=""/></a></div>
                        <div><a href="https://www.prokoncept.hu/"><img src="./assets/img/ytong.png" alt=""/></a></div>
                    </div>
                </section>
                <section id="contact" class="py-6">
                    <div class="text mx-4">
                        <h4 class="mb-05 text-center"><strong class="slash">\</strong> Kapcsolat</h4>
                        <h2 class="mb-1 text-center mb-4">Platina 3000 Kft.</h2>
                        <div class="grid mx-4 data">
            ...
            <footer>
                <div class="grid info mb-4">
                    ...
                    <div>
                        <h2>Navigáció</h2>
                        <a href="referenciak.html"><p>Referenciák</p></a>
                        <a href="index.html#prices"><p>Árak</p></a>
                        <a href="index.html#work"><p>Kivitelezés</p></a>
                        <a href="index.html#planning"><p>Tervezés</p></a>
                    </div>
                    <div>
